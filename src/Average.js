...
const Average = ({results, handleFormSubmit})=>
    ...
    {results.map(result => {
         ...
         return  <div key="10"className="panel">
                    <h4>Your average daily sugar intake is: </h4>
                         ...
                         <h5> Which, if that's above your daily caloric needs</h5><h5> potentially amounts to {Math.floor((((((nf_sugars*35)/7)-25)*365)*4)/3500)} pounds per year!</h5>
